...
Builds reusable street units and placements from a saved Atlas blueprint.

| Folder | Purpose | Dependencies | Input / output |
| --- | --- | --- | --- |
| [construction/units](../src/construction/units/CONTRACT.md) | Plans 8 m units, fitted junctions and independent props. | architecture, district, surfaces, markings, hardware | [input](../src/architecture/native-schema.ts), [output](../src/schema/street-kit.ts) |
...
| [construction](../src/construction/CONTRACT.md) | Builds reusable surfaces and original feature instances. | architecture, district, markings, surfaces | [result](../src/schema/street-kit.ts) |
