...
Authored district maps and letter-atlas display surfaces resolve safe nested paths inside the theme asset tree. Display effects and optional solid emission parameters follow the Materials schema; source and authored provenance remain separate in the retained binding.
