...
Atlas road frames, approach stations and legal turn IDs determine placement. Source edge and double center lines, dashed lanes, plain white bars, bordered yellow crossings, arrow silhouettes and full decal UVs retain their original dimensions. Longitudinal UV phase belongs to the authored piece. Lane dashes repeat 4 m painted and 4 m clear across an 8 m cycle. `artifactPlan` returns original scan poses and dimensions for independent marking placements. Crossing marks occupy the declared receiving field. Highway paint belongs to the delegated highway renderer. Unknown nonstraight grade frames fail explicitly.
