...
Buffers retain coordinates as doubles until piece encoding. Every vertex has position, normal, UV, wear and height relative to the road. Hardware keeps its original normals and UVs; surface normals follow actual triangle geometry. Physical and noncolliding paint/decal batches are distinct. Coverage claims refer only to emitted receiving surfaces, never new ground owners.
