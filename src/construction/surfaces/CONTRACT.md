...
`parking` emits the source 3 by 2.5 m panels inside each exact bay, 1 mm above the road, without painted dividers. `asphalt` accepts a supplied wear sampler on a 16 m grid; its road domain excludes those parking panels and station shafts.
