...
Runs use 8 m cross sections and plain 4 m and 2 m closures. Fractional remainders scale a plain closure. Junction paint, corner seams and zone palettes are baked. Arrows, drain faces and scans use shared overlay pieces. Placements contain transforms and shader values. Coverage and collision use whole transformed footprints; accepted overhangs remain in the report. Construction uses one calling thread.
