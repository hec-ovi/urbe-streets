...
Takes [Atlas architecture](../../architecture/native-schema.ts), seed and wear; returns reusable local [pieces and placements](../../schema/street-kit.ts). Streets uses the existing district surfaces, edge profiles, markings and hardware.
...
Dependencies: [district](../district/CONTRACT.md), [surfaces](../surfaces/CONTRACT.md), [markings](../markings/CONTRACT.md), [features](../features/CONTRACT.md), [style](../style/CONTRACT.md), [assets](../../assets/CONTRACT.md).
